...
tokenizer = GPT2Tokenizer.from_pretrained('/home/dataset/opt-125m')
dataset = load_dataset('lambada', split='validation[:1000]')
evaluator = Evaluator(dataset, tokenizer)

# FP16 Model Accuracy and Latency
model_fp16 = OPTForCausalLM.from_pretrained(
    '/home/dataset/opt-125m', torch_dtype=torch.float16, device_map='auto')
...
model_smoothquant = Int8OPTForCausalLM.from_pretrained(
    '/home/dataset/opt-125m-smoothquant', torch_dtype=torch.float16, device_map='auto')
